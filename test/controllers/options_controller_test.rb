...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { Question_id: @option.Question_id, correct: @option.correct, text: @option.text }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { Question_id: @option.Question_id, correct: @option.correct, text: @option.text }
    assert_redirected_to option_path(assigns(:option))
  end
